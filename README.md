...
|---------|-------------------------|-----------|--------------------------|------------------------------------------------------------------------------------|
| v1.5.x  | Pekko-1.x,2.x JDK >= 17 | 5.6.2     | 2.13, 3.3                | JDK: OpenJdk17,21,25; Scala: 2.13.18,3.3.8; Pekko: 1.1.5,1.6.0,2.0.0-M3            |
...
| v1.0.x  | Pekko-1.0 JDK >= 11     | 5.4.x     | 2.12, 2.13, 3.1          | JDK: OpenJdk11,17; Scala: 2.12.17,2.13.10,3.3.1; Pekko: 1.0.1                      |
...
be a class that is used internally by a top-level class. The reason for it: Pekko sees
